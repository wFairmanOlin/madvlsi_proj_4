...
N 300 70 300 120 { lab=xxx}
N 300 70 360 70 { lab=xxx}
...
N 360 20 360 90 { lab=xxx}
N 360 -20 360 10 { lab=xxx}
N 0 240 360 240 { lab=vn}
N -0 -140 360 -140 { lab=vp}
N -0 -140 0 -80 { lab=vp}
N -30 -140 0 -140 { lab=vp}
N -30 240 -0 240 { lab=vn}
N 360 10 360 20 { lab=xxx}
N 360 20 410 20 { lab=xxx}
...
value=74k
m=1}
C {devices/code_shown.sym} 430 -110 0 0 {name=s1 only_toplevel=false value="
.param w=5
.param l=2
.param Mn=8
"}
...
C {devices/opin.sym} 410 20 0 0 {name=p3 lab=iout}
