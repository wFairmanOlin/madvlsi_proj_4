...
N -760 -130 -620 -130 { lab=GND}
N -620 -130 -620 -90 { lab=GND}
N 80 -180 80 -130 { lab=Vin}
N -50 -180 80 -180 { lab=Vin}
...
save all
dc Vsweep 0 1.8 .001
wrdata ~/Desktop/madvlsi/madvlsi_proj_4/data/vds_sweep.txt i(VloutI) i(VldumpI) v(Vin) v(Vgate) v(D0) i(VinI) i(VgateI) v(VloutV) v(VldumpV) i(Vout) i(Vdump)
.endc
"}
