...
N 330 -70 370 -70 { lab=#net4}
N 380 -70 500 -70 { lab=#net5}
N 330 50 360 50 { lab=#net6}
N 370 50 370 220 { lab=#net7}
N 750 -130 770 -130 { lab=#net8}
N 750 160 770 160 { lab=#net8}
N 500 -70 500 -60 { lab=#net5}
N 500 -60 530 -60 { lab=#net5}
N 370 220 370 230 { lab=#net7}
N 370 230 530 230 { lab=#net7}
N 860 -30 860 -10 { lab=#net8}
N 860 50 860 80 { lab=GND}
N 770 -30 860 -30 { lab=#net8}
N 770 -130 770 -30 { lab=#net8}
N 770 -30 770 160 { lab=#net8}
N -110 -150 -50 -150 { lab=GND}
N 240 -170 280 -170 { lab=Vg~}
N 280 -170 280 -140 { lab=Vg~}
N -350 120 -350 140 { lab=Vg}
N -350 200 -350 230 { lab=GND}
N -350 100 -350 120 { lab=Vg}
N -350 100 -290 100 { lab=Vgl}
N -50 -150 -50 -60 { lab=GND}
N 60 -90 110 -90 { lab=#net9}
...
C {madvlsi/ammeter1.sym} 110 -90 3 0 {name=Vin}
...
C {devices/lab_pin.sym} -350 100 1 0 {name=l11 sig_type=std_logic lab=Vg}
C {devices/lab_pin.sym} -330 100 1 0 {name=l22 sig_type=std_logic lab=Vg~}
C {devices/lab_pin.sym} 240 -170 0 0 {name=l23 sig_type=std_logic lab=Vg~}
C {devices/lab_pin.sym} -310 100 1 0 {name=l24 sig_type=std_logic lab=Vgl}
C {devices/lab_pin.sym} 170 -70 0 0 {name=l49 sig_type=std_logic lab=Vgl}
C {devices/code_shown.sym} 1010 -280 0 0 {name=s1 only_toplevel=false value="
.control
set wr_vecnames
set wr_singlescale
save all
...
.endc
"}
C {madvlsi/vsource.sym} -350 170 0 0 {name=Vgate
value=1.8}
C {madvlsi/gnd.sym} -350 230 0 0 {name=l21 lab=GND}
C {madvlsi/gnd.sym} -50 -60 0 0 {name=l3 lab=GND}
C {madvlsi/vsource.sym} 60 -60 0 0 {name=Vds
value=1.8}
C {madvlsi/gnd.sym} 60 -30 0 0 {name=l32 lab=GND}
